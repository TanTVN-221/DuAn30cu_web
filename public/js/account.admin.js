// var quanLyDiemDanhChamCong = document.querySelector(".quan-ly-diem-danh-cham-cong")
// quanLyDiemDanhChamCong.onclick = function() {
// 	document.querySelectorAll(".card").forEach(element => {
// 		element.style.display = "none"
// 	});
// 	document.querySelector(".card-quan-ly-diem-danh-cham-cong").style.display = "block"
	
// }

// var quanLyLopHoc = document.querySelector(".quan-ly-lop-hoc")
// quanLyLopHoc.onclick = function() {
// 	document.querySelectorAll(".card").forEach(element => {
// 		element.style.display = "none"
// 	});
